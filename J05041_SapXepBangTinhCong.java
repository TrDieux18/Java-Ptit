...
public class J05041_SapXepBangTinhCong {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<TienLuong3> a = new ArrayList<>(n);
        for(int i = 0; i < n; i++){
            TienLuong3 t = new TienLuong3();
            t.Input(sc);
            a.add(t);
        }
        Collections.sort(a, new Comparator<TienLuong3>() {
           public int compare(TienLuong3 x, TienLuong3 y){
                return y.getThuclinh() - x.getThuclinh();
           } 
        });
        for(TienLuong3 i : a){
