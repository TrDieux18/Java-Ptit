...
public class J05061_SapXepKetQuaXetTuyen {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<SXKQXT> a = new ArrayList<>(n);
        for (int i = 0; i < n; i++) {
            SXKQXT xt = new SXKQXT();
            xt.Input(sc);
            a.add(xt);
        }

        a.sort((x,y) -> x.getDiemTB() != y.getDiemTB() ? Double.compare(y.getDiemTB(), x.getDiemTB()) : x.getId().compareTo(y.getId()));
